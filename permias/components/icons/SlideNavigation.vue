<template>
  <div class="slide-navigation-container">
    <div class="arrows next-arrow-up" @click="updateProgress('next')">
    ...
    <div class="arrows prev-arrow-down" @click="updateProgress('prev')">
      <svg xmlns="http://www.w3.org/2000/svg" width="18.859" height="11.024" viewBox="0 0 18.859 11.024">
        <g id="DragNav" transform="translate(18.859) rotate(90)">
  ...
  methods: {
    ...
    updateProgress(direction) {
      if (!this.updatingOfficer) {
        if (direction !== 'none') {
          direction === 'next' ? this.increment() : this.decrement();
        }
